'use strict';
const challengeHeading = challengeNumber =>
  console.log(
    `################ CODING CHALLENGE #${challengeNumber} ################`
  );
...
sectionHeading('Working with Strings part-2');
///////////////////////////////////////
...
/*
sectionHeading('Working with Strings part-1');
///////////////////////////////////////
...
///////////////////////////////////////
sectionHeading('Iteration(Maps, Sets)');
// Maps: Iteration
...
///////////////////////////////////////
// Maps: Fundamentals
console.log('Setting values to a Map()');
const rest = new Map();
...
console.log('Array into map:', rest);
...
console.log('orderSet:', ordersSet);
...
// ordersSet.clear();
console.log('ordeSet Again:', ordersSet);
...
console.log('Name Set:', new Set('jonasschmedtmann').size);
...
///////////////////////////////////////
sectionHeading('Looping Objects: Object Keys, Values, and Entries');
...
console.log('OpeningHrs values:', values);
...
4. During the game, Bayern Munich (team 1) used 3 substitute players. So create a new array 
  ('players1Final') containing all the original team1 players plus 'Thiago', 'Coutinho' and 
  'Perisic'
5. Based on the game.odds object, create one variable for each odd (called 'team1', 'draw' 
  and 'team2')
6. Write a function ('printGoals') that receives an arbitrary number of player names (NOT an 
  array) and prints each of them to the console, along with the number of goals that were scored
